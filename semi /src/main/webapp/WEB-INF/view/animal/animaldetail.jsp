	...
	<div class="container-sm">
		...
		<br>
			...
			<div class="text-center">
				<c:choose>
					<c:when test="${not empty lgnss }">
						<a class="btn btn-outline-secondary" href="<%=request.getContextPath()%>/animalre">수정</a>
					</c:when>
				</c:choose>
					<a class="btn btn-outline-secondary" href="<%=request.getContextPath()%>/animalboard">목록</a> 
			</div>
